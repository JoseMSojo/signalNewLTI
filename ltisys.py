    ...
    *system : arguments
    ...
    def __mul__(self,other):
        if type(other) in [int, float]:
            return lti(self.num*other,self.den)
        elif type(other) in [TransferFunction, lti]:
    ...
    def __div__(self,other):
        if type(other) in [int, float]:
            return lti(self.num,self.den*other)
        if type(other) in [TransferFunction, lti]:
    ...
    def __rdiv__(self,other):
        if type(other) in [int, float]:
            return lti(other*self.den,self.num)
        if type(other) in [TransferFunction, lti]:
    ...
    def __add__(self,other):
        if type(other) in [int, float]:
            return lti(polyadd(self.num,self.den*other),self.den)
        if type(other) in [TransferFunction, type(self)]:
